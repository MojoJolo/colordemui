...
export default function Gpt52Form({ onGenerate, isGenerating, images = [] }) {
  ...
  function handleSubmit(e) {
    ...
    onGenerate([prompt.trim()], "gpt-5.2", null, {
  ...
  return (
    <form className="prompt-form" onSubmit={handleSubmit}>
      <div className="klein-form-header">
        <span className="klein-model-badge">gpt-5.2</span>
      ...
      <label htmlFor="gpt52-prompt" className="prompt-label">Prompt</label>
      <textarea
        id="gpt52-prompt"
